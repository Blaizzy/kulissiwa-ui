<template>
    ...
    <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 class="mt-8 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Welcome back</h2>
        </div>

        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6 bg-white px-10 rounded" action="#" method="POST">
                <div>
                    <label for="email" class="text-base font-medium leading-6 text-gray-900">Email address</label>
                    <div class="mt-2">
                        <input 
                        ...
                        class="w-full rounded-md border-2 border-gray-300 p-1.5 text-gray-900 ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-sky-500 sm:text-sm sm:leading-6" />
                    </div>
                </div>

            
                <div>
                    <button type="submit" class="flex w-full justify-center rounded-md bg-sky-500 px-3 py-1.5 text-base font-semibold leading-6 text-white  shadow-sm hover:bg-sky-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-400" @click.prevent="signInWithEmail" v-if="!email_auth_loading" >Sign in</button>
                ...
                <div>
                    <button class="flex items-center justify-center w-full px-3  border-2 border-gray-300 text-gray-500 rounded mt-2 hover:bg-gray-200" @click.prevent="signInWithGoogle"
                ...
                <div>
                    <button class="flex items-center justify-center w-full px-3  border-2 border-gray-300 text-gray-500 rounded mt-2 hover:bg-gray-200" @click.prevent="signInWithGitHub"
                    :class="email_auth_loading || social_auth_loading ? 'cursor-not-allowed' : ''">
