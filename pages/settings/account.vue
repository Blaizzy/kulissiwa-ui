<template>
    <div class="flex flex-col items-center pt-4 pb-6 bg-white dark:bg-neutral-950 dark:text-gray-400" >
        ...
        <div class="flex flex-col gap-4 w-1/3 px-8 bg-neutral-100/50 dark:bg-neutral-900 p-4 rounded-lg font-light">
        ...
        <div class="flex flex-col mt-4 gap-4 w-1/3 px-8 bg-neutral-100/50 dark:bg-neutral-900 p-4 rounded-lg font-light">
            <div class="flex items-center justify-between py-2">
        ...
        <div class="mt-4 flex justify-end w-1/3 px-4">
